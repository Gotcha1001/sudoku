...
export default function Navbar() {
  ...
  return (
    <motion.nav
      className="flex items-center justify-between px-6 py-4 border-b bg-white dark:bg-gradient-to-r dark:from-blue-900 dark:via-blue-950 dark:to-slate-950 border-gray-200 dark:border-blue-800 shadow-sm dark:shadow-blue-900/50"
      initial={{ y: -40, opacity: 0 }}
      animate={{ y: 0, opacity: 1 }}
      transition={{ duration: 0.4 }}
    >
      ...
      <div className="flex items-center gap-3">
        <SignedOut>
          <Link href="/sign-in">
            <Button
              variant="ghost"
              className="text-gray-700 dark:text-blue-200 hover:text-blue-600 dark:hover:text-blue-300"
            >
              Sign In
            </Button>
          </Link>
          <Link href="/sign-up">
            <Button className="bg-blue-600 dark:bg-blue-700 text-white hover:bg-blue-500 dark:hover:bg-blue-600">
              Sign Up
            </Button>
          </Link>
        </SignedOut>
